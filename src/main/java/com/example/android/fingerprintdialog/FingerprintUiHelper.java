...
public class FingerprintUiHelper extends FingerprintManager.AuthenticationCallback {
    ...
    public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
        ...
        new SendAttendanceTask().execute();
    ...
    private class SendAttendanceTask extends AsyncTask<Void, Void, Void> {
        @Override
    ...
    private void sendAttendance() {
        String targetURL = "http://kuljeet.herokuapp.com/attend/addattendance";
        URL url;
        ...
        try {
            ...
            wr.writeBytes("user_id=S00001&password=xyz");
            wr.flush();
            wr.close();
